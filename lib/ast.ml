...
and 'a stmt_node =
  ...
  | For of 'a expr option * 'a expr * 'a expr option * 'a stmt (* For loop *)
...
and 'a top_decl =
  | TopDeclComponent of 'a component_decl
  | TopDeclInterface of 'a interface_decl
  | TopDeclConnection of connection list    (* Refactor FIXME *)
